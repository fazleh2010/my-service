...
import my.org.weblicht.core.ReferencesTool;
...
public class ReferencesResource {
    ...
    public ReferencesResource() {
        // create your tool (this is for the case when you want to have only one
        // instance of your tool per application to be created and shared among
        // the clients. E.g. if your tool is expensive to construct or if it
        // consumes big amount of memory. See another example for the case
        // when you want to create your tool for each client request)
        try {
            tool = new ReferencesTool();
